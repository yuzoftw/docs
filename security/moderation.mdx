...
It’s recommended to use custom commands like `staff` and `admin` to give users their roles instead of assigning them manually. This makes managing roles easier and more consistent.
